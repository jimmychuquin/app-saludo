...
@Component({
  ...
  template: `
    <main class="page">
      <section class="card">
        <h1>Prueba Saludo Implementacion 5</h1>
        <p class="subtitle">Frontend conectado con backend-saludo 5</p>
        ...
        <h2 class="message">{{ mensajeFinal || 'Haz clic en los botones para consumir las APIs y comprobar el funcionamiento del backend 5' }}</h2>
      </section>
    </main>
  `
})
