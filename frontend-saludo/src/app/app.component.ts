...
@Component({
  ...
  template: `
    <main class="page">
      <section class="card">
        <h1>Aplicacion de Prueba Saludo Implementacion back-front</h1>
        ...
        <h2 class="message">{{ mensajeFinal || 'Haz clic en los botones para consumir las APIs y comprobar el funcionamiento' }}</h2>
      </section>
    </main>
  `
})
